                    ...
                    {Zaxis && (
                        <div className='flex flex-col justify-start h-52 border-t-2 border-[#e2e8f0] w-full text-gray p-6'>
                            ...
                            <div className='mb-4'>
                                ...
                                <div className='text-primary border-2 border-[#e2e8f0] flex items-center p-2 rounded-md'>
                                <input type='text' value={Zlabel} onChange={(e) => setZlabel(e.target.value)} className='w-full outline-none text-primary' />
                                <img src={CrossImg} alt="pen-icon" className='w-8 hover:cursor-pointer' onClick={removeZAxis} />
                                </div>
                            </div>
                            )}
